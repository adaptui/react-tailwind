...
import { useToast } from "./newToast/Toaster";
import { useToasts } from "./newToast/useToasts";
import { Button, ButtonGroup } from "../../button";
import { ToastProvider } from "./newToast/ToastProvider";
  ...
  const ref = React.useCallback(
    (el: HTMLElement | null) => {
      if (el) {
        ...
        updateHeight(toast.id, boundingRect.height);
      }
    },
    [updateHeight, toast.id],
  );
