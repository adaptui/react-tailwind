export const input = {
  ...
  base:
    "lib:appearance-none lib:w-full lib:outline-none lib:px-2 lib:py-1 lib:text-xs lib:shadow-sm lib:font-medium lib:text-gray-500 lib:border lib:h-6 lib:border-gray-300 lib:hover:border-gray-400 lib:rounded-md lib:focus:text-gray-800 lib:focus:border-blue-500 lib:focus:shadow-input",
  disabled: "lib:bg-gray-100 lib:shadow-none",
