export const input = {
  ...
  children: {
    ...
    base: "lib:flex lib:items-center lib:justify-center lib:text-xs lib:absolute lib:inset-y-0 lib:h-6 lib:text-gray-800 lib:bg-transparent lib:border lib:border-transparent lib:rounded-md lib:focus-within:outline-none lib:focus-within:border-blue-500 lib:focus-within:shadow-input ",
    prefix: "lib:left-0",
    suffix: "lib:right-0",
  },
  ...
  group: {
    ...
    children: {
      base: "lib:inline-flex lib:items-center lib:h-6 lib:text-xs lib:font-medium lib:text-gray-800 lib:border lib:border-gray-300 lib:shadow-sm lib:focus-within:outline-none lib:focus-within:border-blue-500 lib:focus-within:shadow-input lib:focus-within:z-10",
