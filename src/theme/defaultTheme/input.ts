export const input = {
  ...
  prefix:
    "flex items-center justify-center text-xs absolute inset-y-0 left-0 h-6 px-2 text-gray-800 bg-transparent border border-transparent rounded-md focus:outline-none focus:border-blue-500 focus:shadow-input",
  suffix:
    "flex items-center justify-center text-xs absolute inset-y-0 right-0 h-6 px-2 text-gray-800 bg-transparent border border-transparent rounded-md focus:outline-none focus:border-blue-500 focus:shadow-input",
